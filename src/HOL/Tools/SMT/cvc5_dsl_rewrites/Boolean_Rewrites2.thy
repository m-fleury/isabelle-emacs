...
lemma [rewrite_bool_or_true]:
  ...
  subgoal for yss xss 
    ...
    by (simp add: bool_or_true_lemma)
  done
...
lemma [rewrite_bool_or_false]:
  ...
  subgoal for yss xss 
    apply (simp add: cvc_list_left_transfer cvc_list_right_transfer_op cvc_list_both_transfer_op)
    by (simp add: bool_or_false_lemma)
  done
...
lemma [rewrite_bool_and_true]:
  ...
  subgoal for yss xss 
    apply (simp add: cvc_list_left_transfer cvc_list_right_transfer_op cvc_list_both_transfer_op)
    by (simp add: bool_and_true_lemma)
  done
...
lemma [rewrite_bool_and_false]:
  ...
  subgoal for yss xss 
    apply (simp add: cvc_list_left_transfer cvc_list_right_transfer_op cvc_list_both_transfer_op)
    by (simp add: bool_and_false_lemma)
  done

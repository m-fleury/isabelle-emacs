...
(*Generated by hand*)
named_theorems bool_double_neg_elim \<open>added by hand\<close>
lemma [bool_double_neg_elim]:
  shows "\<not> (\<not>x) = x"
  by auto
named_theorems eq_symm \<open>added by hand\<close>
lemma [eq_symm]:
  shows "a = b \<longleftrightarrow> b = a"
  by auto
named_theorems eq_refl \<open>added by hand\<close>
lemma [eq_refl]:
  shows "a = a"
  by auto
end
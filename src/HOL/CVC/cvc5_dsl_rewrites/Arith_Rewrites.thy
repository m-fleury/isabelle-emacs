...
lemma [rewrite_arith_plus_zero]:
  ...
  shows "NO_MATCH a (undefined t s) ==> cvc_list_right (+) (cvc_list_left (+) t (0::int)) s =
...
lemma [rewrite_arith_mul_one]:
  fixes t::"int cvc_ListVar" and s::"int cvc_ListVar"
  shows "NO_MATCH a (undefined t s) ==> cvc_list_right (*) (cvc_list_left (*) t (1::int)) s =
...
lemma [rewrite_arith_mul_zero]:
  fixes t::"int cvc_ListVar" and s::"int cvc_ListVar"
  shows "NO_MATCH a (undefined t s) ==> cvc_list_right (*) (cvc_list_left (*) t (0::int)) s = (0::int)"
  apply (cases s)
  apply (cases t)
  subgoal for ss ts 
    apply (simp add: cvc_list_left_transfer cvc_list_right_transfer_op cvc_list_both_transfer_op)
...
lemma [rewrite_arith_neg_neg_one]:
  fixes t::"nat"
  shows "NO_MATCH a (undefined t) ==> - (1::int) * (- (1::int) * t) = t"
  by auto
...
lemma [rewrite_arith_elim_uminus]:
  fixes t::"int"
  shows "NO_MATCH a (undefined t) ==> - t = - (1::int) * t"
  by auto
...
lemma [rewrite_arith_elim_minus]:
  ...
  shows "NO_MATCH a (undefined t s) ==> t - s = t + - (1::int) * s"
  by auto
...
lemma [rewrite_arith_elim_gt]:
  ...
  shows "NO_MATCH a (undefined t s)==> (s < t) = (\<not> t \<le> s)"
...
lemma [rewrite_arith_elim_lt]:
  fixes t::"'a::linorder" and s::"'a::linorder"
  shows "NO_MATCH a (undefined t s) ==> (t < s) = (\<not> s \<le> t)"
    using linorder_not_less by blast
...
lemma [rewrite_arith_elim_leq]:
  ...
  shows "NO_MATCH a (undefined t s) ==> (t \<le> s) = (t \<le> s)"
  by auto
...
lemma [rewrite_arith_leq_norm]:
  fixes t::"int" and s::"int"
  shows "NO_MATCH a (undefined t s) ==> (t \<le> s) = (\<not> s + (1::int) \<le> t)"
  by auto
...
lemma [rewrite_arith_geq_tighten]:
  fixes t::"int" and s::"int"
  shows "NO_MATCH a (undefined t s)  ==> (\<not> s \<le> t) = (t + (1::int) \<le> s)"
  by auto
...
lemma [rewrite_arith_refl_leq]:
  fixes t::"'a::linorder"
  shows "NO_MATCH a (undefined t) ==> (t \<le> t) = True"
  by auto
...
lemma [rewrite_arith_refl_lt]:
  fixes t::"'a::linorder"
  shows "NO_MATCH a (undefined t) ==> (t < t) = False"
  by auto
...
lemma [rewrite_arith_plus_flatten]:
  ...
  shows "NO_MATCH a (undefined xs w ys zs) ==> cvc_list_right (+) (cvc_list_left (+) xs (cvc_list_right (+) w ys)) zs =
...
lemma [rewrite_arith_mult_dist]:
  ...
  shows "NO_MATCH a (undefined x y z w) ==> x * cvc_list_right (+) (y + z) w = x * y + x * cvc_list_right (+) z w"
  apply (cases w)
  subgoal for ws 
    apply (simp add: cvc_list_left_transfer cvc_list_right_transfer_op cvc_list_both_transfer_op)
...
and r::"'a::{zero,plus,one,times,uminus} cvc_ListVar"
  shows "NO_MATCH a (undefined t x s r) ==> cvc_list_right (+)
